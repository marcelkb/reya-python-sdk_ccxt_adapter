...
def main():
    ...
    symbol = 'ETH/RUSD:RUSD'  # market symbol
    ...
    print(exchange.create_order(symbol, EOrderType.LIMIT.value, EOrderSide.BUY.value, 0.001, ticker['last'] * 0.5))
    ...
    result = exchange.create_order(symbol, EOrderType.LIMIT.value, EOrderSide.BUY.value, 0.01, ticker['last'] * 0.5)
    ...
    print(exchange.create_market_order(symbol, EOrderSide.BUY.value, 0.01, ticker['last'] * 1.01))

    print(f"Creating LIMIT BUY order for {symbol}")
    print(exchange.create_limit_order(symbol, EOrderSide.BUY.value, 0.01, ticker['last'] * 0.5))
    ...
    print(exchange.create_order(
        ...
        0.001,
        ticker['last'] * 1.01,
        params={'takeProfitPrice': '125000', 'reduceOnly': True}
    ))
    ...
    print(exchange.create_order(
        ...
        0.001,
        ticker['last'] * 1.01,
        params={'stopLossPrice': '101000', 'reduceOnly': True}
    ))
