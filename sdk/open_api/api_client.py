...
from sdk.open_api.api_response import ApiResponse, T as ApiResponseT
import sdk.open_api.models
from sdk.open_api import rest
from sdk.open_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sdk.open_api.models, klass)
